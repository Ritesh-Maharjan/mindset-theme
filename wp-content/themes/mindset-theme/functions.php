...
function fwd_setup()
{
	...
	// custom crop sizes
	add_image_size('potrait-blog', 200, 250, true);
	// custom crop sizes
	add_image_size('featured-image-blog', 400, 200, true);
...
function fwd_scripts()
{
	...
	wp_enqueue_script('top', get_template_directory_uri() . '/js/top.js', array(), _S_VERSION, array('strategy' => 'defer'));

	wp_enqueue_style('top', get_template_directory_uri() . '/css/top.css', array(), _S_VERSION);

}
add_action('wp_enqueue_scripts', 'fwd_scripts');

/**
 * Register Custom Post Types & custom templates.
 */
...
// change excerpt length from 55 to 20 words (blog page)
...
// cahnge excerpt more text to link 
...
{
	// Templated for Test (Blocks) page 77
...
// hiding the default block editor
function fwd_post_filter($use_block_editor, $post)
{
	// Change 112 to your Page ID
	$page_ids = array(93, 12);
